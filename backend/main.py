...
# --- Project Exporter Tool Helper Functions ---
...
async def process_structure(request: ProcessRequest):
    """Combines all files in a project structure into a single file (TXT or DOCX)."""
    try:
        final_content = ""
...
async def export_zip_structure(request: ProcessRequest):
    """Exports all files in a project structure into a ZIP archive."""
    try:
