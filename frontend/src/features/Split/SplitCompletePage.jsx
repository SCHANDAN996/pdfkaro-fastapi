...
const SplitCompletePage = () => {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4">
            ...
            {isLoading ? (
                 <div className="text-center h-64 flex flex-col justify-center items-center"><LoaderCircle className="animate-spin" size={48} /><p className="mt-4">Generating final previews...</p></div>
            ) : error ? (
