...
import os
import logging
from pydantic import BaseModel # <-- यहाँ 'pydantic' सही किया गया है
    ...
    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zip_file:
        for file in files:
            try:
                ...
                for page in source_pdf.pages:
                    for key, image_obj in page.images.items():
                        try:
                            ...
                            pil_image.thumbnail((pil_image.width * target_dpi / pil_image.info.get('dpi', (72,72))[0], pil_image.height * target_dpi / pil_image.info.get('dpi', (72,72))[1]))
                ...
                continue
    zip_buffer.seek(0)
    return StreamingResponse(zip_buffer, media_type="application/zip", headers={"Content-Disposition": "attachment; filename=compressed_by_PDFkaro.in.zip"})
